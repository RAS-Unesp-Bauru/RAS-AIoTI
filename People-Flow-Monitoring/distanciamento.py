...
mqttBroker ="000.000.00.0"
client = mqtt.Client("client_name")
client.connect(mqttBroker, port=0000)
client.will_set('RAS/AIoTI/People_flow/status', payload="Encerrado", qos=0)
client.publish("RAS/AIoTI/People_flow/status", "Iniciado")
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    info = "Num.: {} - Data de Acesso: {}".format(len(det),localtime)
                    print(info)
                    client.publish("RAS/AIoTI/People_flow/num", len(det))
                    client.publish("RAS/AIoTI/People_flow/acesso", localtime)
                    #----------------------------------------------------------------------------
